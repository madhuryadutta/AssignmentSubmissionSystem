...
use App\Http\Controllers\AssignmentControl;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::post('submitAns/{ass_id}',[viewQuestionController::class, 'submitAns'])->name('submitAns');
Route::get('submitted-assignments', [AssignmentControl::class, 'marksObtain']);
