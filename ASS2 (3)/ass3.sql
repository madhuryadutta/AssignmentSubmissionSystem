...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 20, 2023 at 02:25 PM
...
(10, 3, 15, 1, NULL, '2023-01-20 08:52:47', '2023-01-20 08:52:47');
...
(4, 15, 'what is what?', 2, NULL, NULL),
(5, 15, 'what is lol', 3, NULL, NULL);
...
(1, 'Biraj Khound', 'birajkhound@bk', '4', 4, 2, 'M', 'Joypur', '$2y$10$w8H/1q2.BTyA/rDSn2Tpj.v2RgcgJCmjiEX1JwZaUcyJA//teo2dO', '2022-12-19', '2022-12-18 08:46:05', '2023-01-20 07:35:52'),
(3, 'Madhurya Dutta', 'md@md', '1', 4, 2, 'M', 'Lakhimpur', '$2y$10$o/58Z2vivDGRnqV4AUG.iOUQv0/T6N/pL7JeD3Gnc.UdYLbqDlXga', '2022-12-20', '2022-12-19 12:35:46', '2023-01-20 08:44:09');
...
CREATE TABLE IF NOT EXISTS `sub_ans` (
  ...
  KEY `studen_foreign` (`student_id`),
  KEY `assign_foreign` (`assignment_id`)
...
(131, 3, 4, 15, '2', '2023-01-20 05:30:08', '2023-01-20 05:30:08'),
(132, 3, 5, 15, '1', '2023-01-20 05:30:08', '2023-01-20 05:30:08'),
(133, 3, 4, 15, 'fff', '2023-01-20 06:50:54', '2023-01-20 06:50:54'),
(134, 3, 5, 15, 'ddd', '2023-01-20 06:50:54', '2023-01-20 06:50:54'),
(135, 3, 4, 15, 'yyy', '2023-01-20 08:43:32', '2023-01-20 08:43:32'),
(136, 3, 5, 15, 'tt', '2023-01-20 08:43:32', '2023-01-20 08:43:32'),
(137, 3, 0, 15, 'BCL-2023-CV-biraj.pdf-1674224012.pdf', '2023-01-20 08:43:32', '2023-01-20 08:43:32'),
(138, 3, 4, 15, 'hhh', '2023-01-20 08:52:47', '2023-01-20 08:52:47'),
(139, 3, 5, 15, 'ddd', '2023-01-20 08:52:47', '2023-01-20 08:52:47'),
(140, 3, 0, 15, 'BCL-2023-CV-biraj.pdf-1674224567.pdf', '2023-01-20 08:52:47', '2023-01-20 08:52:47');
...
--
ALTER TABLE `sub_ans`
  ADD CONSTRAINT `assign_foreign` FOREIGN KEY (`assignment_id`) REFERENCES `assignments` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `studen_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
